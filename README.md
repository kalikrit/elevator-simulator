...
- **Вызов с указанием этажа назначения** – на каждом этаже есть кнопка "Вызвать". Перед этим нужно ввести в верхнем поле этаж, на который вы хотите поехать. Лифт приедет на ваш этаж, затем отвезёт на указанный.
- **Очереди лифтов** – каждый лифт обрабатывает поездки последовательно. Все промежуточные этажи добавляются в очередь.
